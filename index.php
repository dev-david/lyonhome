				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h2 class="alt">Thinking about selling <span class="blackblock"> 3638 Lyon Ave? </span> Let us help! This is YOUR personal team of professionals. Whether you have questions about purchasing or selling, you can rest assured when you have your own Team of Fast Agents backing you.</h2>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							...
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 3638 Lyon Ave</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>4014 Santa Rita St</strong></h3>
										<ul>
											<li>3 Bed - 2 Bath</li>
											<li>1,400 Sq Ft -  5,200 Lot</li>
											<li>List: 3/7/13 - Pending: 5/8/13</li>
											<li>List: $399,000 - SOLD $464,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>3125 Eastman Ave</strong></h3>
										<ul>
											<li>3 Bed - 2 Bath</li>
											<li>1728 Sq Ft - 6,525 Lot</li>
											<li>List: 4/11/13 - Pending: 6/24/13</li>
											<li>List: $449,000 - SOLD $460,000</li>
										</ul>
									</article>
								</div>
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>3520 Lyon Ave</strong></h3>
										<ul>
											<li>3 Bed - 2 Bath</li>
											<li>1662 Sq Ft - 4,200 Lot</li>
											<li>List: 8/2/13 - Pending: 8/28/13</li>
